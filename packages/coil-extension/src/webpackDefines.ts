...
declare const WEBPACK_DEFINE_REDEEMER_DOMAIN: any
declare const WEBPACK_DEFINE_SIGNER_DOMAIN: any
...
export const REDEEMER_DOMAIN: string = WEBPACK_DEFINE_REDEEMER_DOMAIN
export const SIGNER_DOMAIN: string = WEBPACK_DEFINE_SIGNER_DOMAIN
